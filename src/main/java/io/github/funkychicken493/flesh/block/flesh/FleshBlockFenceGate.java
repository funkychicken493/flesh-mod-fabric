...
/**
 * The type Flesh block fence gate.
 */
@SuppressWarnings("unused")
public class FleshBlockFenceGate extends FenceGateBlock implements LandingBlock {
    /**
     * Instantiates a new Flesh block fence gate.
     *
     * @param settings the settings
     */
    public FleshBlockFenceGate(FabricBlockSettings settings) {
        super(settings);
    }
