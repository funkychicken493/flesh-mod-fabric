...
/**
 * The type Flesh block fence.
 */
@SuppressWarnings("unused")
public class FleshBlockFence extends FenceBlock implements LandingBlock {
    /**
     * Instantiates a new Flesh block fence.
     *
     * @param settings the settings
     */
    public FleshBlockFence(FabricBlockSettings settings) {
        super(settings);
    }
